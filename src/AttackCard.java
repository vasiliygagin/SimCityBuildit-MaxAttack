...
public enum AttackCard {
	...
	public static final AttackCard[] AVAILABLE = { ComicHand, ShrinkRay, GiantRockMonster, TentacleVortex,
			PlantMonster };
	public static final AttackCard[] ENERGY_EFFICIENT = filterEnergyEfficient(AVAILABLE);
	...
	private static AttackCard[] filterEnergyEfficient(AttackCard[] cards) {
