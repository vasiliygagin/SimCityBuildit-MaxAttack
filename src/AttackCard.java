...
public enum AttackCard {
    ...
    TentacleVortex(2, 3, 200, new WarItemQuantity(WarItem.Plunger, 1), new WarItemQuantity(WarItem.RubberDuck, 1),
    ...
    Fishaster(7, 7, 700, new WarItemQuantity(WarItem.RubberDuck, 1), new WarItemQuantity(WarItem.RubberBoots, 3), new WarItemQuantity(WarItem.FireHydrant, 3)),
    ...
    SixteenTonns(6, 6, 600, new WarItemQuantity(WarItem.Pliers, 1), new WarItemQuantity(WarItem.FireHydrant, 1), new WarItemQuantity(WarItem.Anvil, 4)),
    ...
    public static final AttackCard[] AVAILABLE = { ComicHand, ShrinkRay, GiantRockMonster, TentacleVortex, PlantMonster };
