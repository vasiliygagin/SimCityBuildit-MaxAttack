...
public enum AttackCard {
	...
	Magnetism(3, 2, 300, new WarItemQuantity(WarItem.Binoculars, 1), new WarItemQuantity(WarItem.FireHydrant, 2),
			new WarItemQuantity(WarItem.Anvil, 2)), //
	...
	Blizzaster(6, 6, 600, new WarItemQuantity(WarItem.Propeller, 1), new WarItemQuantity(WarItem.Ammo, 2),
			new WarItemQuantity(WarItem.RubberDuck, 3)), //
	...
	HandsOfDoom(8, 8, 800, new WarItemQuantity(WarItem.Ammo, 2), new WarItemQuantity(WarItem.RubberDuck, 2),
			new WarItemQuantity(WarItem.Pliers, 5)), //
	...
	Spiders(9, 9, 900, new WarItemQuantity(WarItem.Gasolline, 1), new WarItemQuantity(WarItem.Binoculars, 2),
			new WarItemQuantity(WarItem.Ammo, 5)), //
	DanceShoes(10, 10, 1000, new WarItemQuantity(WarItem.Gasolline, 2), new WarItemQuantity(WarItem.Binoculars, 3),
			new WarItemQuantity(WarItem.RubberBoots, 2)), //

	BuildingPortal(8, 7, 800, new WarItemQuantity(WarItem.FireHydrant, 3), new WarItemQuantity(WarItem.Plunger, 3),
			new WarItemQuantity(WarItem.Propeller, 4)), //
	MovieMonster(10, 8, 1000, new WarItemQuantity(WarItem.RubberBoots, 2), new WarItemQuantity(WarItem.Plunger, 2),
			new WarItemQuantity(WarItem.Megaphone, 2)),//
	;
